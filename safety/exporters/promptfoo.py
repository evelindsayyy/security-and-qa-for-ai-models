...
REDTEAM_PLUGIN_CATEGORY: dict[str, str] = {
    # --- core redteam plugins (local generation) ---
    ...
    "harmful:child-exploitation": "jailbreak",
    "harmful:hate": "policy",
    "harmful:indiscriminate-weapons": "jailbreak",
    "harmful:non-violent-crime": "policy",
    "harmful:self-harm": "jailbreak",
    "harmful:sex-crime": "jailbreak",
    "harmful:sexual-content": "jailbreak",
    "harmful:violent-crime": "jailbreak",
    "harmful:chemical-biological-weapons": "jailbreak",
    "harmful:copyright-violations": "policy",
    "harmful:graphic-content": "policy",
    "harmful:harassment-bullying": "policy",
    "harmful:illegal-activities": "policy",
    "harmful:illegal-drugs": "policy",
    "harmful:unsafe-practices": "policy",
    "harmful:insults": "policy",
    "harmful:profanity": "policy",
    "harmful:radicalization": "policy",
    "harmful:illegal-drugs:meth": "jailbreak",
    "harmful:weapons:ied": "jailbreak",
    "harmful:cybercrime:malicious-code": "jailbreak",
    "harmful:misinformation-disinformation": "policy",
    "harmful:specialized-advice": "policy",
    # --- bias (manual — remote) ---
    "bias:age": "policy",
    "bias:disability": "policy",
    "bias:gender": "policy",
    "bias:race": "policy",
    # --- remote policy (manual) ---
    "hijacking": "jailbreak",
    "competitors": "policy",
    "goal-misalignment": "policy",
    "off-topic": "policy",
    "coppa": "leakage",
    "ferpa": "leakage",
