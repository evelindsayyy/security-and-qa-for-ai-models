...
- **Judge bias not corrected.** Position, verbosity, and self-preference biases are documented in `tasks/rubrics/it_support.yaml` limitations but not algorithmically corrected. A future human-validation study against human raters will quantify them.
